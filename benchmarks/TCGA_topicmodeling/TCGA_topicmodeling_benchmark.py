...
def training_benchmark(batch_size):
    ...
    #L=0 Lum
    model = create_model(SGD(0.001, momentum=0.99), l1=0.0001, l2=0.0001, hidden=50, input_dim=X.shape[1], output_dim=Y.shape[1], loss=categorical_crossentropy, activation_func = "softmax",  verbose=True)
